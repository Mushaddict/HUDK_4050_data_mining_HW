...
```{r}
df_test_clean <- read_csv("output data/df_test_clean.csv")

submission <- data.frame(
     StudentID = test$StudentID,
     Dropout = test$Dropout
 )
write.csv(submission,file=("~/Desktop/submission.csv"),row.names = FALSE)
```
